...
public class ClickButtonSpring2 : MonoBehaviour
{
    ...
    GameObject Button1;
    GameObject Button2;
    GameObject Button3;GameObject go;
    GameObject Button4;
    ...
    void OnMouseDown()
    {
        ...
        Engine.transform.position = new Vector3(-14.5f, 6.56f + 0.6f, 15.4f);float b = (float)MathScript.arr[GlobalVariables.c, GlobalVariables.b];
